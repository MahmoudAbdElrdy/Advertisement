...
namespace AuthApplication.Advertisement.Command {
  public class GetAllAdvertisementDashBoardCommand : Paging, IRequest<PageList<AdvertisementDto>> {
    class Handler : IRequestHandler<GetAllAdvertisementDashBoardCommand, PageList<AdvertisementDto>> {
      ...
      public async Task<PageList<AdvertisementDto>> Handle(GetAllAdvertisementDashBoardCommand request, CancellationToken cancellationToken) {
