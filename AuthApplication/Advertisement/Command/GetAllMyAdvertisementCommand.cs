...
namespace AuthApplication.Advertisement.Command {
  public class GetAllMyAdvertisementCommand : Paging, IRequest<PageList<AdvertisementDto>> {
    class Handler : IRequestHandler<GetAllMyAdvertisementCommand, PageList<AdvertisementDto>> {
      ...
      public async Task<PageList<AdvertisementDto>> Handle(GetAllMyAdvertisementCommand request, CancellationToken cancellationToken) {
