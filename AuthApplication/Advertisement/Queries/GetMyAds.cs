...
{
    public class GetMyAds : IRequest<List<AdsDto>>
    {
         class Handler : IRequestHandler<GetMyAds, List<AdsDto>>
        {
            ...
            public async Task<List<AdsDto>> Handle(GetMyAds request, CancellationToken cancellationToken)
            {
                ...
                var query = _context.Ads
                  ...
                  .Where(c => c.AdIntervals.Any(c => c.ClientId == UserId))
                  .Take(10);
