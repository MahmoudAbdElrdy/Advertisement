...
namespace Persistence.MSSQL.Migrations
{
    ...
    [Migration("20210603233344_ServiceTypeDesc")]
    partial class ServiceTypeDesc
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthDomain.Entities.Ads.AdComplaint", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(256)")
                    ...
                    b.Property<string>("ComplaintReasonReplay")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool?>("IsComplaintSeen")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("AdComplaints");
                });

            modelBuilder.Entity("AuthDomain.Entities.Ads.AdFavourite", b =>
                {
                    b.Property<string>("Id")
                    ...
                    b.ToTable("AdFavourites");
                });

            modelBuilder.Entity("AuthDomain.Entities.Ads.AdInterval", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(256)")
                    ...
                    b.Property<int>("NumberOfShowTimes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthDomain.Entities.Ads.GeneralConfiguration", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AuthDomain.Entities.Ads.Installment", b =>
                {
                    ...
                    b.Property<string>("AdIntervalId")
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("AuthDomain.Entities.Ads.OrderComplaint", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(256)")
                    ...
                    b.ToTable("OrderComplaint");
                });

            modelBuilder.Entity("AuthDomain.Entities.Ads.Rating", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AuthDomain.Entities.ContactUs", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ResponesAdmin")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AuthDomain.Entities.Ads.Installment", b =>
                {
                    ...
                    b.HasOne("AuthDomain.Entities.Ads.AdInterval", "AdInterval")
                        .WithMany("Installments")
                        .HasForeignKey("AdIntervalId");
                });
            ...
            modelBuilder.Entity("AuthDomain.Entities.FreeService", b =>
                {
                    ...
                    b.HasOne("AuthDomain.Entities.Service", null)
                        .WithMany("FreeServices")
